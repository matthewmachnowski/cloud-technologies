...
def create_json_dict(excel_file: str, keywords_file: str) -> List[Dict]:
    ...
    # Load alcohol brands and types from the provided Excel file
    ...
    alcohol_list = [
        {
            ...
            "children": list(alcohol_dict["distilled"].values()),
        },
        {
            "name": "fermented",
            "keywords": keywords_dict["fermented"].get("general", []),
            "children": list(alcohol_dict["fermented"].values()),
        },
    ]
